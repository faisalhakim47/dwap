...
(function (Dwap) {
    var Repository = /** @class */ (function () {
        function Repository(CDN) {
            if (CDN === void 0) { CDN = 'https://cdn.statically.io/gh/faisalhakim47/dwap/1.1.6'; }
            this.CDN = CDN;
        }
