namespace Dwap {
    ...
    export class Repository {
        constructor(
            private CDN: string = 'https://cdn.statically.io/gh/faisalhakim47/dwap/1.1.6',
        ) {}
        ...
        getDistricts(provinceId: string, regencyId: string) {
            return this.getMany<District>('districts', provinceId, regencyId);
        }
    
        getVillages(provinceId: string, regencyId: string, districtId: string) {
        ...
        getRegency(provinceId: string, regencyId: string) {
        ...
        getDistrict(provinceId: string, regencyId: string, districtId: string) {
        ...
        getVillage(provinceId: string, regencyId: string, districtId: string, villageId: string) {
    ...
    export class ViewBinder {
        ...
        private renderOptions(select: HTMLSelectElement, options: Array<GenericOption>) {
            this.emptyOptions(select);
